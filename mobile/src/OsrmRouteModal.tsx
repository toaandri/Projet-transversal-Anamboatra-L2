...
/**
 * Itinéraire in-app (OSRM + suivi GPS) — même logique que les équipes d'intervention
 * (@see app/(app)/ticket/[id].tsx). Réutilisable pour missions patrouille / suggestion citoyenne.
 */
...
export function OsrmRouteModal({
  ...
  /** Ligne descriptive sous le titre (ex. type + début de description). */
  subtitle: string;
  /** Icône Ionicons dans le pin destination. */
