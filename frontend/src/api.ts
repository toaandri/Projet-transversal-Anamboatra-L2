...
/** Jeton partagé optionnel (X-Admin-Token) — legacy / dépannage. */
...
/**
 * Appels admin : acceptent soit le JWT d'un SUPER_ADMIN (par défaut) soit un
 * X-Admin-Token passé explicitement. Côté backend les deux sont valides.
 */
...
export const api = {
  ...
  /* Agents de réparation (EQUIPE_INTERVENTION) */
