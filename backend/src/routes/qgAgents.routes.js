 ...
 * Le QG ne peut manipuler que les agents de patrouille de SA zone.
 *
 * Les équipes d'intervention (EQUIPE_INTERVENTION) sont désormais créées par
 * le super-admin (cf. admin.routes.js) et rattachées à un DEPOT_REPARATION.
 *
 * Actions :
