/**
 * Charte Anamboatra — alignée sur la vitrine web et le dashboard QG.
 * Palette officielle : blanc / vert (drapeau Madagascar) / rouge.
 */
export const colors = {
  bg: '#f4faf6',
  panel: '#ffffff',
  ...
  // Statuts ticket (mêmes valeurs que côté web)
  danger: '#dc2626',
  ok: '#22c55e',
  warning: '#f59e0b',
  info: '#3b82f6',
